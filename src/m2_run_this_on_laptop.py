...
def main():
    ...
    # -------------------------------------------------------------------------
    # teleop_frame, drive_system_frame, beeps_tones_frame, arm_frame, control_frame,
    # sensor_frame, tone_frame = get_shared_frames(main_frame, mqtt_sender)

    # -------------------------------------------------------------------------
    # Frames that are particular to my individual contributions to the project.
    # -------------------------------------------------------------------------
    m2_marching_frame, m2_salute_frame, m2_af_morale_frame, m2_sensor_frame = get_my_frames(main_frame, mqtt_sender)

    # -------------------------------------------------------------------------
    # Grid the frames.
    # -------------------------------------------------------------------------
    my_grid_frames(m2_marching_frame, m2_salute_frame, m2_af_morale_frame, m2_sensor_frame)
...
def get_my_frames(main_frame, mqtt_sender):
    ...
    m2_sensor_frame = shared_gui.get_m2_sensor_frame(main_frame,mqtt_sender)

    return m2_marching_frame, m2_salute_frame, m2_af_morale_frame, m2_sensor_frame
